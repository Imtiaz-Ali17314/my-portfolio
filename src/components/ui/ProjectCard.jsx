            ...
            <div className="flex items-center gap-2 select-none">
              {project.live && project.live !== "#" && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-1.5 px-3.5 py-1.5 rounded-xl text-[10px] font-extrabold transition-all duration-300 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-md shadow-indigo-500/10 hover:shadow-indigo-500/20 active:scale-95"
              ...
              {project.github && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-1.5 px-3.5 py-1.5 rounded-xl text-[10px] font-extrabold transition-all duration-300 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900/60 dark:hover:bg-slate-800 text-slate-700 dark:text-[#beafdc] border border-slate-200 dark:border-[#2d1e5a]/80 hover:border-indigo-500/30 active:scale-95"
                  title="View Codebase"
                >
